namespace VanillaPsycastsExpanded
{
    ...
    public class FocusStrengthOffset_ResearchSpeed : FocusStrengthOffset
    {
        ...
        public override string GetExplanation(Thing parent) =>
            "Difficulty_ResearchSpeedFactor_Label".Translate() + ": " + this.GetOffset(parent).ToStringPercent();
        ...
        public override string GetExplanationAbstract(ThingDef def = null)
        {
            ...
            return "Difficulty_ResearchSpeedFactor_Label".Translate() + ": " +
                   (this.offset * def.GetStatValueAbstract(StatDefOf.ResearchSpeedFactor)).ToStringPercent();
        }
    }
}